...
import newsemc.com.awit.news.newsemcappdftl.dao.OASysInfo;
import newsemc.com.awit.news.newsemcappdftl.interfaces.HttpResultListener;
import newsemc.com.awit.news.newsemcappdftl.interfaces.OaSysInter;
 ...
 */
public class OaSysImpl implements OaSysInter {
    private String TAG="OaSysImpl";
    private HttpResultListener httpResultListener;
    private FailRequest failRequestobj;
    private List<OASysInfo> oaSysInfoList;
    public OaSysImpl(HttpResultListener httpResultListener){
        this.httpResultListener=httpResultListener;
    }
    @Override
    public void getOaSysInfoList(String ssid,String userId, String infotype, String pageno, String pagesize, String ifhead) {
        ...
        client.post(
                ...
                new AsyncHttpResponseHandler() {
                    ...
                    public void onSuccess(int arg0, Header[] arg1, byte[] arg2) {
                        ...
                        Log.i(TAG, "succ");
                        oaSysInfoList=new ArrayList<OASysInfo>();
                        JSONArray jsonArr;
                        ...
                        try {
                            ...
                            for (int i = 0; i < dataarr.length(); i++) {
                                ...
                                OASysInfo oaSysInfobj= new OASysInfo();
                                oaSysInfobj.setFileid(jsonObject.getString("fileid"));
                                oaSysInfobj.setHandleid(jsonObject.getString("handleid"));
                                oaSysInfobj.setDetail(jsonObject.getString("detail"));
                                oaSysInfobj.setTitle(jsonObject.getString("title"));
                                oaSysInfoList.add(oaSysInfobj);
                            }
                            httpResultListener.onResult(oaSysInfoList);
                             }
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
