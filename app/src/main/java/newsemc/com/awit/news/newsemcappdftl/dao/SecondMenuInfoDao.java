...
/**
 * DAO for table SECOND_MENU_INFO.
*/
public class SecondMenuInfoDao extends AbstractDao<SecondMenuInfo, String> {

    public static final String TABLENAME = "SECOND_MENU_INFO";

    /**
     * Properties of entity SecondMenuInfo.<br/>
    ...
    */
    ...
    public SecondMenuInfoDao(DaoConfig config) {
        super(config);
    }
    
    public SecondMenuInfoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'SECOND_MENU_INFO' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'SECOND_MENU_INFO'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, SecondMenuInfo entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public SecondMenuInfo readEntity(Cursor cursor, int offset) {
        SecondMenuInfo entity = new SecondMenuInfo( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, SecondMenuInfo entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(SecondMenuInfo entity, long rowId) {
        return entity.getId();
    }
    
    /** @inheritdoc */
    @Override
    public String getKey(SecondMenuInfo entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
