...
import newsemc.com.awit.news.newsemcappdftl.bean.ImgInfoList;
 ...
 */
public class AnnoucementFragment extends Fragment implements HttpResultListener,ZrcListView.OnItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = (View)inflater.inflate(R.layout.workfragment, null);
        prp=(TextView)view.findViewById(R.id.prp);
        back=(Button)view.findViewById(R.id.back);
        prp.setText("公司信息-通知公告");
        ...
        imgInfoListImpl.getImgInfoList(ssid,account, "12", "1", "10", "1");
        ...
        zrcListView.setOnRefreshStartListener(new ZrcListView.OnStartListener() {
            ...
            public void onStart() {
                ...
                ImgInfoListImpl imgInfoListImpl = new ImgInfoListImpl(AnnoucementFragment.this);
                imgInfoListImpl.getImgInfoList(ssid,account, "12", page, "10", "2");
    ...
    public void onResult(Object obj) {
        if(obj instanceof FailRequest){
            ...
            if(compwnylist.size()>0){
                ...
                ImgInfoListImpl imgInfoListImpl = new ImgInfoListImpl(AnnoucementFragment.this);
                imgInfoListImpl.getImgInfoList(ssid,account, "12",
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(pageNo==1){
            ...
            ImgInfoListImpl imgInfoListImpl = new ImgInfoListImpl(this);
            imgInfoListImpl.getImgInfoList(ssid,account, "12", pageNo+"", "10", "2");
        }
    }
}
