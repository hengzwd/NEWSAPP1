...
import newsemc.com.awit.news.newsemcappdftl.http.AsyncImageLoader1;

/**
 * Created by admin on 2016/2/26.
 */
public class HttpImgListAdapter1 extends BaseAdapter {
    ...
    public HttpImgListAdapter1(Context context, List<String> list,ListView listView,int scrWidth) {
    ...
    public View getView(int position,  View convertView, ViewGroup parent) {
        // TODO Auto-generated method stub
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.img_list1,
                    null);
        }
        ...
        Bitmap cachedImage = asyncImageLoader.loadDrawable(url,scrWidth, new AsyncImageLoader1.ImageCallback() {
