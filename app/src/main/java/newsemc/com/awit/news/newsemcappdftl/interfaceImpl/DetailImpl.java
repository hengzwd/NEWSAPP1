...
import newsemc.com.awit.news.newsemcappdftl.dao.DetailInfo;
import newsemc.com.awit.news.newsemcappdftl.interfaces.DetailInter;
...
public class DetailImpl implements DetailInter {
    ...
    public void getDetailInfoList(String ssid,String userId, String infotype, String infoid) {
        ...
        Log.i(TAG, "infoid" + infoid);
        Log.i(TAG,"ssid" + ssid);
//        client.setTimeout(ValueConfig.TIME_OUT);
        String url = ValueConfig.PCAPP_URL + "inter/inter!jsInfoDetail.action";
        client.post(
                url,
                params,
                new AsyncHttpResponseHandler() {
                    ...
                    public void onSuccess(int arg0, Header[] arg1, byte[] arg2) {
                        ...
                        Log.i(TAG, "succ");
                        detailInfoList=new ArrayList<DetailInfo>();
                        JSONArray jsonArr;
...
//                                jsonObject = new JSONObject(data);
                                DetailInfo detailInfobj= new DetailInfo();
                                detailInfobj.setInfoid(dataarr.getString("infoid"));
                                detailInfobj.setInfotype(dataarr.getString("infotype"));
                                detailInfobj.setNum(dataarr.getString("num"));
                                detailInfobj.setHtmlpath(dataarr.getString("htmlpath"));
                                detailInfoList.add(detailInfobj);
//                            }
