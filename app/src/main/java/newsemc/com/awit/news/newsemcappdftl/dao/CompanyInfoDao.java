...
public class CompanyInfoDao extends AbstractDao<CompanyInfo, String> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Infodate = new Property(6, String.class, "infodate", false, "INFODATE");
        public final static Property Num = new Property(7, String.class, "num", false, "NUM");
        public final static Property Pageno = new Property(8, String.class, "pageno", false, "PAGENO");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'COMPANY_INFO' (" + //
                ...
                "'INFODATE' TEXT," + // 6: infodate
                "'NUM' TEXT," + // 7: num
                "'PAGENO' TEXT," + // 8: pageno
    ...
    public CompanyInfo readEntity(Cursor cursor, int offset) {
        CompanyInfo entity = new CompanyInfo( //
            ...
            cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6), // infodate
            cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7), // num
            cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8), // pageno
    ...
    public void readEntity(Cursor cursor, CompanyInfo entity, int offset) {
        ...
        entity.setInfodate(cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6));
        entity.setNum(cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7));
        entity.setPageno(cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8));
