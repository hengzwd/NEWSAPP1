...
import newsemc.com.awit.news.newsemcappdftl.interfaces.CompanyNewInter;
 ...
 */
public class CompanyNewImpl implements CompanyNewInter {
    ...
    public CompanyNewImpl(HttpResultListener httpResultListener){
                        ...
                        try {
                            ...
                            if (Integer.parseInt(s) != 0) {
                                ...
                                for (int i = 0; i < dataarr.length(); i++) {
                                    ...
                                    CompanyInfo companyInfobj = new CompanyInfo();
                                    companyInfobj.setInfoid(jsonObject.getString("infoid"));
                                    companyInfobj.setInfourl(jsonObject.getString("infourl"));
                                    companyInfobj.setInfoname(jsonObject.getString("infoname"));
                                    companyInfobj.setInfoimg(jsonObject.getString("infoimg"));
                                    companyInfobj.setInfotype(jsonObject.getString("infotype"));
                                    companyInfobj.setInfodate(jsonObject.getString("infodate"));
                                    companyInfobj.setNum(jsonObject.getString("num"));
                                    companyInfoList.add(companyInfobj);
                                }
                                httpResultListener.onResult(companyInfoList);
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
