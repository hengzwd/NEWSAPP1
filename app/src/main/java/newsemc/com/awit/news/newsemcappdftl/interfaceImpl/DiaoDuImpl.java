...
import newsemc.com.awit.news.newsemcappdftl.dao.DiaoDuInfo;
import newsemc.com.awit.news.newsemcappdftl.interfaces.DiaoDuInter;
 ...
 */
public class DiaoDuImpl implements DiaoDuInter {
    private String TAG="DiaoDuImpl";
    private HttpResultListener httpResultListener;
    private List<DiaoDuInfo> diaoDuInfoList;
    private FailRequest failRequestobj;

    public DiaoDuImpl(HttpResultListener httpResultListener){
        this.httpResultListener=httpResultListener;
    }

    @Override
    public void getDiaoDuInfoList(String ssid,String userId, String infotype, String pageno, String pagesize, String ifhead) {
...
//        client.setTimeout(ValueConfig.TIME_OUT);
        String url = ValueConfig.PCAPP_URL + "inter/inter!interImage.action";
        ...
        client.post(
                ...
                new AsyncHttpResponseHandler() {
                    ...
                    public void onSuccess(int arg0, Header[] arg1, byte[] arg2) {
                        ...
                        Log.i(TAG, "succ");
                        diaoDuInfoList=new ArrayList<DiaoDuInfo>();
                        JSONArray jsonArr;
                        ...
                        try {
                            ...
                            if(Integer.parseInt(s) !=0){
                                ...
                                for (int i = 0; i < dataarr.length(); i++) {
                                    ...
                                    DiaoDuInfo diaoDuInfobj = new DiaoDuInfo();
//                                    diaoDuInfobj.setDocCode(jsonObject.getString("docCode"));
                                    diaoDuInfobj.setFiletitle(jsonObject.getString("filetitle"));
                                    diaoDuInfobj.setUploaddate(jsonObject.getString("uploaddate"));
                                    diaoDuInfobj.setNum(jsonObject.getString("num"));
                                    diaoDuInfoList.add(diaoDuInfobj);
                                }
                                httpResultListener.onResult(diaoDuInfoList);
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
